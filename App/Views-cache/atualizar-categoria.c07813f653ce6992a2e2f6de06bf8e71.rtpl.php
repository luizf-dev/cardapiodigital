...
<form class="form-add" method="POST" action="/cardapiodigital/admin/atualizar-categoria/<?php echo htmlspecialchars( $categoria["id_categoria"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    ...
    <div class="form-actions">
        <a href="/cardapiodigital/admin/categories" class="btn-form default">
