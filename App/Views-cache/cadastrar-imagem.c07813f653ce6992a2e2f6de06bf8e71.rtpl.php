<?php if(!class_exists('Rain\Tpl')){exit;}?>    <?php if( $msgErro != '' ){ ?>        
    ...
    <form class="form-add" action="/cardapiodigital/admin/cadastrar-imagem/<?php echo htmlspecialchars( $produtos["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="POST" enctype="multipart/form-data">       
